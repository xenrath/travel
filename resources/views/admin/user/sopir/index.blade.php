...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="{{ url('admin/sopir/create') }}" class="btn btn-outline-primary btn-sm float-end">
            ...
            @foreach ($users as $user)
              <tr>
                ...
                <td class="text-center">
                  <a href="{{ url('admin/sopir/' . $user->id) }}" class="btn btn-info btn-sm">
                    <i class="fas fa-eye"></i> Lihat
                  </a>
                  <a href="{{ url('admin/sopir/' . $user->id . '/edit') }}" class="btn btn-warning btn-sm">
                  ...
                  <div class="modal fade" id="modalHapus{{ $user->id }}" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog mt-6" role="document">
                      <div class="modal-content border-0">
                        ...
                        <div class="modal-footer">
                          ...
                          <form action="{{ url('admin/sopir/' . $user->id) }}" method="POST"
                            id="delete{{ $user->id }}">
                            @csrf
                            @method('delete')
                          </form>
