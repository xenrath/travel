        ...
        <tbody class="list">
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="{{ url('admin/pelanggan/' . $user->id) }}" class="btn btn-info btn-sm">
                <i class="fas fa-eye"></i> Lihat
              </a>
              <a href="{{ url('admin/pelanggan/' . $user->id . '/edit') }}" class="btn btn-warning btn-sm">
                ...
                <div class="modal-dialog mt-6" role="document">
                  <div class="modal-content border-0">
                    ...
                    <div class="modal-footer">
                      ...
                      <form action="{{ url('admin/pelanggan/' . $user->id) }}" method="POST" id="delete{{ $user->id }}">
                        @csrf
                        @method('delete')
                      </form>
                    </div>
