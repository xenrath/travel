...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a href="{{ url('admin/mobil/create') }}" class="btn btn-outline-primary btn-sm float-end">
          ...
          <tbody class="list">
            @foreach ($mobils as $key => $mobil)
              <tr>
                ...
                <td>
                  <img src="{{ asset('storage/uploads/' . $mobil->gambar) }}" alt="{{ $mobil->nama }}" width="160"
                    class="rounded">
                </td>
                <td>
                  @if ($mobil->status)
                  ...
                  <div class="dropdown font-sans-serif position-static">
                    ...
                    <div class="dropdown-menu dropdown-menu-end border py-0">
                      <div class="bg-white py-2">
                        <a class="dropdown-item" href="{{ url('admin/mobil/' . $mobil->id . '/edit') }}">Edit</a>
                ...
                <div class="modal fade" id="modalHapus{{ $mobil->id }}" data-bs-keyboard="false"
                  ...
                  <div class="modal-dialog mt-6" role="document">
                    <div class="modal-content border-0">
                      ...
                      <div class="modal-footer">
                        ...
                        <form action="{{ url('admin/mobil/' . $mobil->id) }}" method="POST"
                          id="delete{{ $mobil->id }}">
                          @csrf
                          @method('delete')
                        </form>
