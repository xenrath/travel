...
<div class="card">
  <div class="card-header">
    ...
    <a href="{{ url('admin/rekening/create') }}" class="btn btn-outline-primary btn-sm float-end">
              ...
              <div class="dropdown font-sans-serif position-static">
                ...
                <div class="dropdown-menu dropdown-menu-end border py-0">
                  <div class="bg-white py-2">
                    <a class="dropdown-item" href="{{ url('admin/rekening/' . $rekening->id . '/edit') }}">Edit</a>
              ...
              <div class="modal-dialog mt-6" role="document">
                <div class="modal-content border-0">
                  ...
                  <div class="modal-footer">
                    ...
                    <form action="{{ url('admin/rekening/' . $rekening->id) }}" method="POST" id="delete{{ $rekening->id }}">
                      @csrf
                      @method('delete')
                    </form>
                  </div>
