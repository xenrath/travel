...
@section('content')
        ...
        <form method="GET" id="form-action">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <button type="button" class="btn btn-success" onclick="rekapexport()" target="_blank">
          ...
          <tbody class="list">
            @forelse ($transaksis as $key => $transaksi)
              <tr>
                ...
                <th>
                  <a href="{{ url('admin/transaksi/riwayat/' . $transaksi->id) }}" class="btn btn-info btn-sm">
  ...
  <script>
    ...
    function cari() {
      form.action = "{{ url('admin/transaksi/riwayat') }}";
      form.submit();
    }

    function print() {
      form.action = "{{ url('admin/transaksi/print') }}";
      form.submit();
    }

    function rekapexport() {
      form.action = "{{ url('admin/transaksi/rekapexport') }}";
      form.submit();
    }
  </script>
@endsection
