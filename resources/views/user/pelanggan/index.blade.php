...
<div class="card">
  <div class="card-header">
    ...
    <a href="{{ url('pelanggan/create') }}" class="btn btn-outline-primary btn-sm float-end">
        ...
        <tbody class="list">
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="{{ url('pelanggan/' . $user->id) }}" class="btn btn-info btn-sm">
                <i class="fas fa-eye"></i> Lihat
              </a>
              <a href="{{ url('pelanggan/' . $user->id . '/edit') }}" class="btn btn-warning btn-sm">
