...
<div class="card">
  <div class="card-header">
    <h5 class="float-start">Tabel Mobil</h5>
    <a href="{{ url('mobil/create') }}" class="btn btn-outline-primary btn-sm float-end">
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody class="list">
          ...
          <tr>
            ...
            <td>
              <img src="{{ asset('storage/uploads/' . $mobil->gambar) }}" alt="{{ $mobil->nama }}" width="160" class="rounded">
            </td>
            <td>
              @if ($mobil->status)
              ...
              <div class="dropdown font-sans-serif position-static">
                ...
                <div class="dropdown-menu dropdown-menu-end border py-0">
                  <div class="bg-white py-2">
                    <a class="dropdown-item" href="{{ url('mobil/' . $mobil->id . '/edit') }}">Edit</a>
                    <a class="dropdown-item text-danger" href="" data-bs-toggle="modal"
                      data-bs-target="#modalHapus{{ $mobil->id }}">Delete</a>
                  </div>
                </div>
              </div>
            </td>
            <div class="modal fade" id="modalHapus{{ $mobil->id }}" data-bs-keyboard="false" data-bs-backdrop="static"
                ...
                <div class="modal-content border-0">
                  ...
                  <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" type="button"
                      onclick="event.preventDefault(); document.getElementById('delete{{ $mobil->id }}').submit();">Hapus</button>
                    <form action="{{ url('mobil/' . $mobil->id) }}" method="POST" id="delete{{ $mobil->id }}">
                      @csrf
                      @method('delete')
                    </form>
                  </div>
