...
class SopirController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.user.sopir.index', compact('users'));
    }
    ...
    {
        return view('admin.user.sopir.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/sopir')->with('status', 'Berhasil menambahkan Sopir');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.user.sopir.show', compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.user.sopir.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/sopir')->with('status', 'Berhasil memperbarui Sopir');
    }
