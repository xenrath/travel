...
class PelangganController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.user.pelanggan.index', compact('users'));
    }
    ...
    {
        return view('admin.user.pelanggan.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/pelanggan')->with('status', 'Berhasil menambahkan pelanggan');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.user.pelanggan.show', compact('user', 'result_lat_long'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.user.pelanggan.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/pelanggan')->with('status', 'Berhasil memperbarui pelanggan');
    }
